...
export class MascarillasTejidasService {
    ...
    pdf.add([
      ...
      new Table([
        ...
        [
          //Contenido con DATA
          //Urdimbre
          new Cell(new Txt(data.headerDto.warpColor).font("Roboto").bold().alignment('center').fontSize(7).end).colSpan(1).end,
          //Forma
      ...
      new Table([
        ...
        [
          ...
          //# Accesorios
          new Cell(new Txt(data.headerDto.numberOfAccessories).font("Roboto").bold().alignment('center').fontSize(7).end).colSpan(1).end,
          //Maquina
        ...
        new Stack([
          new Table([
            [
              //Titulo Padre
              //Observaciones
              new Cell(new Txt(this.translatorFinotex("dataSheetCutedge.tablesix_Notes").toLocaleUpperCase()).bold().alignment('center').fontSize(7).end).fillColor("#C8C9CB").colSpan(4).end,
              null, null, null
            ],
            [
              //Contenido 
              //Observaciones Contenido
              new Cell(new Txt(data.footerDto.observations).bold().alignment('center').fontSize(7).end).colSpan(4).end,
              null, null, null
            ],
            [
              //Titulos Hijos
      ...
      new Columns([
        new Stack([
          new Table([
            ...
            [
              //Archivo Grafico
              new Cell(new Txt(data.footerDto.graphicArtArchive).alignment('center').fontSize(7).end).border([true, false, false, false]).colSpan(1).end,
              //Diseno  
