...
export class OrilloCortadoService
 {
      ...
      new Table([
        ...
        [
          //Contenido con DATA
           ...
           //Talla
           new Cell(new Txt(data.headerDto.size).font("Roboto").bold().alignment('center').fontSize(7).end).colSpan(1).end,
           //Cantidad a Producir
      ...
      new Stack([
        new Table([
          ...
          [
            ...
            //Diseno  
            new Cell(new Txt(this.datePipe.transform(data.footerDto.dateDesigned, 'dd/MM/yyyy')).font("Roboto").bold().alignment('left').fontSize(7).end).colSpan(1).end,
