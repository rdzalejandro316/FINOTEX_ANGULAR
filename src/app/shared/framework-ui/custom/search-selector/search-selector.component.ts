...
@Component({
    ...
    <input
      ...
      class="form-control number-border no-side-gaps"
      aria-describedby="basic-addon2"
      style="text-align:right"
      pInputText
    ...
    <div class="input-group-append">
      <div class="outline-secondary">
        <span [ngClass]="readonly ? 'input-group-append-readonly no-side-gaps' : 'input-group-text no-side-gaps'">{{ titleButton }}</span>
      </div>
    </div>
  </div>`,
    styleUrls: ['./search-selector.component.css'],
