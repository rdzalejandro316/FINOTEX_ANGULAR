...
import { OverlayService, PrimeNGConfig, PrimeTemplate, SelectItem, SharedModule, TranslationKeys } from '../api/public_api';
import { ObjectUtils, UniqueComponentId, ZIndexUtils } from '../utils/public_api';
import { DomHandler } from '../dom/domhandler';
import { ConnectedOverlayScrollHandler } from '../dom/public_api';
    ...
    template: `
         <div #container [ngClass]="{'p-dropdown p-component':true,
            ...
            <div class="p-dropdown-trigger" role="button" aria-haspopup="listbox" [attr.aria-expanded]="overlayVisible">
                <span class="p-dropdown-trigger-icon {{overlayVisible ? 'p-dropdown-open' : '' }}" [ngClass]="dropdownIcon"></span>
            </div>
...
export class Dropdown implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, OnDestroy, ControlValueAccessor {
    ...
    @Input() dropdownIcon: string = 'pi pi-chevron-right';
    ...
    @Input() get filterValue(): string | undefined {
