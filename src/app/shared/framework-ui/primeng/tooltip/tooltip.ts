...
import { PrimeNGConfig } from '../api/public_api';
...
export class Tooltip implements AfterViewInit, OnDestroy {
    ...
    create() {
        ...
        tooltipArrow.className = 'p-tooltip-arrow ' + (this.text.includes('<img') ? 't-img' : '');
    ...
    alignRight() {
        ...
        this.container.style.left = left + this.getOption('positionLeft') + 8 + 'px';
    ...
    alignTop() {
        ...
        let t = this.text.includes('<img') ? - 16 : -3;
        this.container.style.top = top + this.getOption('positionTop') + t + 'px';
    }
