...
import { BlockableUI, Footer, Header, PrimeTemplate, SharedModule } from '../api/public_api';
...
export class Card implements AfterContentInit, BlockableUI {
    ...
    @ContentChild(Header) headerFacet?: null;

    @ContentChild(Footer) footerFacet?: null;
