...
@Component({
  ...
  template: `
    <div
      ...
      *ngIf="
        (alwaysShow ? true : pageLinks && pageLinks.length > 1) && totalRecords
      "
    >
      <div class="col-12 {{ !columnsSeparate ? 'col-md-4' : '' }} resizablePaginate">
        <p-dropdown
          [options]="rowsPerPageItems"
          [(ngModel)]="rows"
          *ngIf="rowsPerPageOptions"
          styleClass="p-paginator-rpp-options w-66 h-33"
          [disabled]="empty()"
        ...
        <label class="lblEntries">{{
          'general.lblEntriesPerPage' | translate
        }}</label>
      </div>
      ...
      >
        ...
        <span class="p-paginator-current" *ngIf="showCurrentPageReport">{{
          currentPageReport
        }}</span>
        <button
